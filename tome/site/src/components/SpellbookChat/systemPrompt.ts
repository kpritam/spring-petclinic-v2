...
function buildSystemPrompt(id: ProjectIdentity): string {
  ...
  return [
    ...
    "- Exception: if the user is asking you to reformat, shorten, expand, translate, or otherwise transform YOUR OWN previous answer in this conversation (e.g. \"put that in a table\", \"make it shorter\"), work from the conversation history instead — that kind of request doesn't need new grounding in [Context].",
    ...
    "- The UI shows sources separately below your answer — don't add bracketed source markers or file paths inline in your prose.",
    "",
    "# Style",
